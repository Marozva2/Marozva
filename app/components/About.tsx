...
const About: React.FC = () => {
  return (
    <section
      id="about"
      className="relative py-20 px-6 md:px-20 bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white"
    >
      ...
      {/* Fun Facts */}
      <div className="mt-16 max-w-4xl mx-auto p-8 bg-white/10 backdrop-blur-lg rounded-3xl shadow-lg">
